...
extern "C" {
    ...
    pub fn dbusmenu_client_get_icon_paths(client: *mut DbusmenuClient) -> c_char;
    ...
    pub fn dbusmenu_server_get_icon_paths(server: *mut DbusmenuServer) -> c_char;
    ...
    pub fn dbusmenu_server_set_icon_paths(server: *mut DbusmenuServer, icon_paths: c_char);
